<?php
 ...
 <body class="fundo1">
    <div>
        ...
        <div>
                <div>  
                    <a href="add.php"><button type="button" class="btn btn-default" data-toggle="tooltip" data-placement="bottom" title="Cadastrar Inquilinos">Cadastrar</button></a> 
                    <br/><br/>           
                    <form method="post">
                    <input type="text" name="txtFiltro"/>
                    <input type="submit" value="Pesquisar" class="btn btn-default" data-toggle="tooltip" data-placement="bottom" title="Perquisar Inquilinos"><br />
                    </form>
                </div>
                <table>
                    <tr class="lista">
